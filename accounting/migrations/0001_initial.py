    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('user_image', models.ImageField(blank=True, null=True, upload_to='media\\ user_image')),
                ...
                ('gender', models.CharField(choices=[('f', 'female'), ('m', 'male')], default='male', max_length=10)),
